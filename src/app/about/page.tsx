	...
	const values = [
		{
			...
			description:
				"I don't just write code; I build solutions that solve real business problems and user pain points.",
		},
		{
			icon: <Shield className="text-emerald-400" />,
			title: "Reliable Architecture",
			description:
				"Scalable, maintainable, and clean code is my standard. I build for the long haul.",
		},
		{
			icon: <Heart className="text-rose-400" />,
			title: "Mentorship",
			description:
				"Sharing knowledge and lifting fellow engineers is just as important as shipping features.",
		},
	];
		...
		<div className="max-w-4xl mx-auto px-6 py-20">
			...
			>
				...
				<div className="p-8 bg-accent-dim border border-accent/20 rounded-3xl mb-16 relative overflow-hidden group">
					...
					<div className="relative z-10">
						...
						<p className="text-muted text-sm mb-6 max-w-md">
							I've kept this page brief, but my full career history,
							certifications, and technical depth are documented in my CV.
						</p>
						<a
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-12">
					<div>
						<h3 className="text-xl font-bold mb-6 italic text-accent-light">
							"Builder by nature."
						</h3>
						<p className="text-muted leading-relaxed">
							When I'm not coding, I'm usually exploring new AI tools, mentoring
							junior engineers, or planning the next big product feature. I
							believe that engineering is as much about people and product as it
							is about code.
						</p>
					</div>
					<div className="bg-surface-2 border border-border rounded-2xl p-6 flex flex-col justify-center">
						<span className="text-sm uppercase tracking-widest text-muted font-bold mb-4">
							Location
						</span>
						<p className="text-lg font-medium">Jakarta, Indonesia 🇮🇩</p>
						<p className="text-sm text-muted mt-2">
							Working globally, based locally.
						</p>
					</div>
				</div>
			</motion.div>

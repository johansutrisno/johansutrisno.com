    ...
    <div className="relative overflow-hidden">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h2 className="text-2xl md:text-3xl font-medium text-muted mb-8 max-w-2xl leading-relaxed">
                <span className="text-foreground">Senior Product Engineer</span> based in Jakarta. 
                I build Flutter apps that people actually use — <span className="text-accent-light">20K+ daily</span>.
              </h2>
              ...
              <div className="flex items-center gap-8 pt-4">
                <div className="flex flex-col">
                  ...
                  <span className="text-xs uppercase tracking-widest text-muted font-bold">Years Exp.</span>
                </div>
                <div className="h-8 w-[1px] bg-border" />
                <div className="flex flex-col">
                  <span className="text-2xl font-bold">20K+</span>
                  <span className="text-xs uppercase tracking-widest text-muted font-bold">Daily Users</span>
                </div>
                <div className="h-8 w-[1px] bg-border" />
                <div className="flex flex-col">
                  <span className="text-2xl font-bold">YC</span>
                  <span className="text-xs uppercase tracking-widest text-muted font-bold">W22 Alumni</span>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            >
              ...
              <div className="w-full aspect-square bg-surface border border-border rounded-3xl p-8 shadow-2xl overflow-hidden group">
                ...
                <div className="h-full flex flex-col justify-between relative z-10">
                  ...
                  <div>
                    <p className="text-sm font-mono text-accent-light mb-2">class SeniorEngineer {"{"}</p>
                    <p className="pl-4 text-sm font-mono text-muted mb-1">expertise: ["Flutter", "AI"];</p>
                    <p className="pl-4 text-sm font-mono text-muted mb-1">mindset: "Product-driven";</p>
                    <p className="pl-4 text-sm font-mono text-muted">location: "Jakarta, ID";</p>
                  ...
                  <div className="h-12 w-full bg-background/50 backdrop-blur-sm rounded-xl border border-border flex items-center px-4 justify-between group-hover:border-accent/30 transition-colors">
                     <span className="text-xs text-muted font-medium italic">Building with purpose...</span>
              ...
              >
                ...
                <span className="text-xs font-bold font-mono">Flutter Expert</span>
              </motion.div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 border-t border-border">
         <div className="flex items-center justify-between mb-12">
            ...
            <Link href="/projects" className="text-accent hover:text-accent-light font-medium flex items-center gap-2 group">
               View All Projects <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
            </Link>
         </div>
         
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-8 bg-surface border border-border rounded-2xl hover:border-accent/30 transition-all group">
               <h3 className="text-xl font-bold mb-3 group-hover:text-accent transition-colors">KickAvenue</h3>
               <p className="text-muted text-sm mb-6 leading-relaxed">Led migration from React Native to Flutter for 20K+ daily users.</p>
            ...
            <div className="p-8 bg-surface border border-border rounded-2xl hover:border-accent/30 transition-all group">
               <h3 className="text-xl font-bold mb-3 group-hover:text-accent transition-colors">Euromedica AIZER</h3>
               <p className="text-muted text-sm mb-6 leading-relaxed">AI-powered dermatology platform with complex animations.</p>
               <div className="flex flex-wrap gap-2">
                  <Badge>AI</Badge>
            ...
            <div className="p-8 bg-surface border border-border rounded-2xl hover:border-accent/30 transition-all group">
               <h3 className="text-xl font-bold mb-3 group-hover:text-accent transition-colors">AppFlowy</h3>
               <p className="text-muted text-sm mb-6 leading-relaxed">Open source contributor to the largest Dart project on GitHub.</p>
               <div className="flex flex-wrap gap-2">
